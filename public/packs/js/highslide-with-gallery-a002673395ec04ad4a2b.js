...
/***/ "./app/javascript/packs/highslide-with-gallery.js":
/*!********************************************************!*\
  !*** ./app/javascript/packs/highslide-with-gallery.js ***!
  \********************************************************/
  ...
  var hs = {
    ...
    init: function init() {
      if (!hs.container) {
        ...
        }, hs.container, 1); // http://www.robertpenner.com/easing/ 
  ...
  hs.Expander.prototype = {
    ...
    changeSize: function changeSize(up, to, dur) {
      ...
      if (this.outline && !this.outlineWhileAnimating) {
        if (up) this.outline.setPosition();else this.outline.destroy();
      }
...
/******/ });
//# sourceMappingURL=highslide-with-gallery-a002673395ec04ad4a2b.js.map